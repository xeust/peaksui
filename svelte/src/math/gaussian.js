...
export function generate(interventions, lower_bound, upper_bound, width, height, margin) {
    console.log(interventions, lower_bound, upper_bound, width, height, margin)
    let rawData = [];
    let data = [];
